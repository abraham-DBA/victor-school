    ...
    return (
        <>
            ...
            <nav className="flex items-center justify-between px-6 md:px-16 lg:px-16 xl:px-6 py-4 border-b border-gray-300 bg-white relative transition-all">
                ...
                {/* Mobile Menu */}
                <div className={`${open ? 'flex' : 'hidden'} absolute top-full left-0 w-full bg-white dark:bg-gray-900 shadow-lg py-4 flex-col items-start gap-3 px-5 text-sm md:hidden z-50 border-t border-gray-200 dark:border-gray-700`}>
                    <Link href="/" onClick={() => setOpen(false)} className="block w-full text-blue-600 dark:text-white hover:text-blue-700 dark:hover:text-gray-200 transition py-2">Home</Link>
                    <a href="#about" onClick={() => setOpen(false)} className="block w-full text-blue-600 dark:text-white hover:text-blue-700 dark:hover:text-gray-200 transition py-2">About</a>
                    <Link href="/contact" onClick={() => setOpen(false)} className="block w-full text-blue-600 dark:text-white hover:text-blue-700 dark:hover:text-gray-200 transition py-2">Contact</Link>
                    <Link href="/register" onClick={() => setOpen(false)} className="cursor-pointer px-6 py-2 mt-2 bg-indigo-500 hover:bg-indigo-600 transition text-white rounded-full text-sm w-full text-center">
                        Register
                    </Link>
                </div>
